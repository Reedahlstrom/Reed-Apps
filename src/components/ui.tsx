...
const buttonVariants: Record<ButtonVariant, string> = {
  ...
  ghost: 'text-ice-200 hover:bg-white/5 border border-transparent',
...
const fieldBase =
  'w-full rounded-xl bg-night-950/60 border border-ice-300/15 px-4 py-3 text-[16px] text-ice-50 ' +
  'placeholder:text-ice-300/40 outline-none transition focus:border-glacier-400/70 focus:bg-night-950/80'
  ...
  return (
    <span
      className={cx(
        ...
        'border border-ice-300/15 bg-white/5 text-ice-200',
        className,
      )}
    >
